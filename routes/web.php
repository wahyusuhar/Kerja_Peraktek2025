...
use App\Http\Controllers\Kasir\ChatBotKasirController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::prefix('kasir')->name('kasir.')->group(function () {
    Route::get('/chatbot', [ChatBotKasirController::class, 'index'])->name('chatBoot');
    Route::post('/chatbot/ask', [ChatBotKasirController::class, 'ask'])->name('chatBoot.ask');
});
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => 'level:1'], function () {
        ...
        // Route::post('/member/cetak', [MemberController::class, 'cetakMember'])->name('member.cetak');
        // Route::post('/member/download', [MemberController::class, 'downloadMember'])->name('member.download');
