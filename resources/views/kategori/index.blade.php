  ...
  <div class="col-lg-12" style="margin-top: 60px;">
      <div class="box" style="border-radius: 8px;">
        ...
        <div class="btn-group" style="margin-bottom: 20px;">
          <button onclick="addForm('{{ route('kategori.store') }}')" class="btn btn-success btn-xs btn-flat" style="font-size: 16px; padding: 10px 20px; border-radius: 3px; box-shadow: rgb(38, 57, 77) 0px 20px 30px -10px; margin-right: 10px; margin-top: -29px;"><i class="fa fa-plus-circle"></i> Tambah Kategori</button>
       </div>
        </div>
...
// Tutup modal saat tombol silang di header diklik
