            ...
            <div class="modal-content" style="width: 550px;">
                ...
                <div class="modal-body py-3">
                    ...
                    <div class="form-group row" style="margin-bottom: 10px;">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="nama" id="nama" class="form-control rounded shadow-sm" required autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="telepon" class="col-md-2 col-form-label text-md-right">Telepon</label>
                        <div class="col-lg-6">
                            <input type="text" name="telepon" id="telepon" class="form-control rounded shadow-sm" required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="alamat" id="alamat" rows="3" class="form-control rounded shadow-sm"></textarea>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                </div>
